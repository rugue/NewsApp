...
/**
 * Helper methods related to requesting and receiving news data from theGuadian.
 */
public final class QueryUtils {

    /**
     * JSON response for a theGuadian query
     */
    ...
    public static List<News> extractNews(String JSON_RESPONSE) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                News newsAdd = new News(section, headline, date, url, author);
                news.add(newsAdd);
            }
